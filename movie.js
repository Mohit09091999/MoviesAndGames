...
function init(resultFromServer) {
  ...
  $("#r0").append(`<div class="row"><button class="btn btn-success" id="bt1" onclick='sh1()'>Show More</button></div>
    `)
...
function init1(resultFromServer1) {
  ...
  $("#r02").append(`<div class="row"><button class="btn btn-success" id="bt2" onclick='sh2()'>Show More</button></div>
    `)
...
function init2(resultFromServer2) {
  ...
  $("#r03").append(`<div class="row"><button class="btn btn-success" id="bt3" onclick='sh3()'>Show More</button></div>
    `)
}
function sh3(){
